...
<body>
    ...
    <main>
        ...
        <div class="pai">
            ...
            <div class="filho">
                <h4 class="h4">IMC é a sigla para Índice de Massa Corpórea, parâmetro adotado pela Organização Mundial
                    de
                    Saúde para
            ...
            <div class="filho">
                <form method="GET" class="forms">
                    ...
                    <button type="submit" name="calcular" value="1" class="btn">Calcular IMC</button>
                    <br>
                </form>
